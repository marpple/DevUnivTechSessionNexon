...
import { session10RenderHandler } from "../../pages/session10/session10RenderHandler";
...
server.get(ClientRouter['/session10'].toString(), session10RenderHandler(ClientRouter['/session10']));
